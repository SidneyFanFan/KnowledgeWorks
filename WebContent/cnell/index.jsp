...
<title>CNELL: Chinese Never-Ending Language Learning</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">CNELL</a><a
					class="navbar-brand subbrand">Knowledge Works</a>
			</div>
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="active"><a href="#">Extraction Display<span class="sr-only">(current)</span></a></li>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="page-header">
					<h1>Relation Extraction Display</h1>
					<h3>中文关系抽取展示</h3>
