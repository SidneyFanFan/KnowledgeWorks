...
<body>
	...
	<div class="container marketing">
		...
		<div class="row">
			<!-- phd -->
			<h2 class="people_categroy">Ph.D Student</h2>
			<hr>
			<c:forEach items="${phds}" var="item">
				<div class="col-sm-12 col-sm-4 col-md-3 col-lg-3">
					...
					<p>
						<!-- page -->
						<a href="${item[7]}" target="_blank" role="button">Personal Page</a>
					</p>
				</div>
			</c:forEach>
		</div><!-- /.row -->
		<div class="row">
			<!-- ms -->
			<h2 class="people_categroy">M.S Student</h2>
			<hr>
			<c:forEach items="${mss}" var="item">
				<div class="col-sm-12 col-sm-4 col-md-3 col-lg-3">
					<c:if test="${item[3]=='#'}">
						<img class="img-circle"
							src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
		...
		<div class="row">
			<!-- bss -->
			<h2 class="people_categroy">Undergraduate Student</h2>
			<hr>
			<c:forEach items="${bss}" var="item">
				<div class="col-sm-12 col-sm-4 col-md-3 col-lg-3">
					<c:if test="${item[3]=='#'}">
						<img class="img-circle"
							src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
